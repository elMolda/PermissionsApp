...
public class CameraActivity extends AppCompatActivity {
    ...
    private Button btnTpr;
    private Button btnGlry;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGlry = findViewById(R.id.btnGlry);
        shwImg = findViewById(R.id.shwImg);
        ...
        if (requestCode == GALLERY) {
            if (data != null) {
                ...
                try {
                    ...
                    shwImg.setImageBitmap(bitmap);

                } catch (IOException e) {
                    e.printStackTrace();
                    Toast.makeText(this, "Falló la operación!", Toast.LENGTH_SHORT).show();
                }
            }

        } else if (requestCode == CAMERA) {
            Bitmap thumbnail = (Bitmap) data.getExtras().get("data");
            shwImg.setImageBitmap(thumbnail);
            saveImage(thumbnail);
        }
    }
